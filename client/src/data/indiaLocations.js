// Comprehensive Indian States and Districts Data for UniScholar

export const STATES_AND_DISTRICTS = {
  'Andhra Pradesh': [
    'Ananthapuramu', 'Chittoor', 'East Godavari', 'Guntur', 'Krishna', 'Kurnool',
    'Nandyal', 'NTR', 'Palnadu', 'Prakasam', 'Srikakulam', 'Sri Potti Sriramulu Nellore',
  ...
  'Arunachal Pradesh': [
    ...
    'Kra Daadi', 'Kurung Kumey', 'Lepa Rada', 'Lhit', 'Longding', 'Lower Dibang Valley',
    'Lower Subansiri', 'Namsai', 'Pakke Kessang', 'Papum Pare', 'Shi Yomi', 'Siang', 'Tawang',
    'Tirap', 'Upper Dibang Valley', 'Upper Subansiri', 'West Kameng', 'West Siang'
  ],
  'Assam': [
